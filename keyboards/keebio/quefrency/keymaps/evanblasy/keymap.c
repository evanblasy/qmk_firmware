...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    KC_TILD, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_DEL,  KC_BSPC, \
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, MO(_FN1),          KC_SPC,  KC_RALT, KC_LGUI, MO(_FN1), KC_RCTL, _______, _______
  ),
  ...
  [_FN1] = LAYOUT(
    ...
    KC_CAPS, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, _______, _______, _______,\
